...
"""Check the actual MSAA color address helper against pinned AMD tables."""
import subprocess
import tempfile
...
'''
for name in ('ps5_tiled_color_msaa4_tile', 'ps5_tiled_affine_offset',
...
print('PASS: actual MSAA color addressing, five texel sizes, 32 layers, all samples and tile boundaries')
